...
export default function Counter() {
  ...
  function counter(isIncrease, options, valueClicked) {
  ...
  return (
      <div className="Counter">
        ...
        <br/>
        <button onClick={ () => counter(true, DEFAULT_INCREMENT_COUNTER_OPTIONS, 1) }>+</button>
        <button onClick={ () => counter(false, DEFAULT_INCREMENT_COUNTER_OPTIONS, 1) }>-</button>
        <br/>

        <h3>Average Percentage: { percentCount } %</h3>
        <br/>
        <button onClick={ () => counter(true, DEFAULT_PERCENTAGE_COUNTER_OPTIONS, incrementBy) }>+</button>
        <button onClick={ () => counter(false, DEFAULT_PERCENTAGE_COUNTER_OPTIONS, incrementBy) }>-</button>
